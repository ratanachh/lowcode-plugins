import { project, event } from '@rchh/lowcode-engine';
import { IPublicTypePluginConfig, IPublicModelPluginContext } from '@rchh/lowcode-types';
import { controller as baseController } from '@rchh/lowcode-plugin-base-monaco-editor/es/controller';
